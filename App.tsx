...
const App: React.FC = () => {
  ...
  const handleAddComponent = (type: ComponentType) => {
    ...
    const newComp: CircuitComponent = {
      ...
      value: type === ComponentType.POTENTIOMETER ? 500 : (type === ComponentType.LDR || type === ComponentType.SOLAR_PANEL ? 50 : 0),
      current: 0,
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen w-full bg-[#0a0f1a] text-slate-100 overflow-hidden select-none font-sans relative">
      ...
      */}
      <div className="lg:hidden flex items-center justify-between p-3 border-b border-slate-800 bg-[#111827] z-50 shadow-md h-14 shrink-0">
      ...
      */}
      <aside className={`
        ...
        ${sidebarOpen 
          ? 'translate-x-0 w-72 lg:w-80 p-5 pt-20 lg:pt-5 opacity-100' 
      ...
      `}>
        ...
        {/* Real-time Telemetry */}
        <div className="grid grid-cols-1 gap-2 bg-slate-900/80 p-4 rounded-xl border border-slate-700 shadow-inner mb-6 shrink-0">
      ...
      <main className="flex-grow relative flex flex-col bg-[#0f172a] grid-bg touch-none min-h-0">
